...
public class LineupView extends AppCompatActivity {
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.homeicon) {
                    ...
                    startActivity(new Intent(LineupView.this, RequestsView.class));
                    finish();
    ...
    //Observes if the User Lineups have any existing players in it or not
    ...
    private void initializePositionViewsAndDefaults() {
        ...
        for (int i = 0; i < allPositions.length; i++) {
            ...
            updatePositionUIAfterChange(positionKey, null); // Set to default
    ...
    private void updatePositionUIAfterChange(String positionKey, Player player) {
        ...
        if (player != null) {
            ...
            if (displayName.isEmpty() || displayName.length() > 7) displayName = positionKey;

            else if (displayName.length() > 5 && displayName.contains(" ")) { // Tries initials if full name is too long
    ...
    private void saveCurrentUserLineup() {
        ...
        lineupToSave.setPlayerPositions(new HashMap<>(currentPlayersInPositions));
